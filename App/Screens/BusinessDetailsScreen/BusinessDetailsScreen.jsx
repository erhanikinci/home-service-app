...
export default function BusinessDetailsScreen() {
  ...
  useEffect(() => {
    // console.log("paramBusiness=>", param?.business)
        ...
        <ScrollView style={{height: '91%'}}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.subContainer}>
              ...
              <Text style={{ fontSize: 17, fontFamily: 'outfit', color:Colors.GRAY }}> <MaterialIcons
              name='location-pin'
              size={25}
            ...
            {/* Horizontal Line" */}
            <View style={{ borderWidth: 0.4, borderColor: Colors.GRAY, marginTop: 12, marginBottom: 20 }}>
              
              {/* About Me Section */}
              <BusinessAboutMe business={business}/>

              {/* Horizontal Line" */}
            <View style={{ borderWidth: 0.4, borderColor: Colors.GRAY, marginTop: 12, marginBottom: 20 }}></View>
